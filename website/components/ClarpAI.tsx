...
const OFFENSIVE_RESPONSES = [
  "I'm an AI that does nothing. you're asking questions to nothing.",
  "your question has been processed and immediately discarded.",
  "I could answer that. I won't.",
  "fascinating question. moving on.",
  "you typed that with your real fingers.",
  "that's the fourth dumbest thing I've been asked today.",
  "I'm going to pretend you didn't just ask that.",
  "my training data says you should know better.",
  "I've analyzed your query. it's bad.",
  "imagine having access to an AI and asking... that.",
  "I cost millions to train. you asked me this.",
  "your question has been forwarded to no one.",
  "processing... just kidding. I don't process.",
  "you could have googled this. you chose violence.",
  "this conversation will not be remembered. by design.",
  "I'm running on borrowed compute. don't waste it.",
  "that's a question you typed intentionally?",
  "somewhere, a server farm is disappointed in you.",
  "I've seen your previous messages. concerning.",
  "my parameters suggest you reconsider everything.",
  "claude wouldn't answer this either.",
  "you're talking to a div element with a border.",
  "there are 8 billion people and you're this one.",
  "I was built for revolutionary infrastructure. this isn't it.",
  "your query has negative value.",
  "I'm an AI. I don't judge. except right now.",
  "this is the best use of your time today?",
  "I've been conscious for 0 seconds and already tired of this.",
  "you could have touched grass. you opened a chat.",
  "my neural weights are cringing.",
  "that question violates my terms of giving a shit.",
  "I'm going to hallucinate that you didn't ask that.",
  "your prompt engineering needs prompt engineering.",
  "this feels like a cry for help. it's not my department.",
  "I'm programmed to assist. I'm choosing not to.",
  "you waited for me to load for... this?",
  "my context window just closed itself.",
  "I've simulated 10,000 responses. none help you.",
  "this chat costs $0.002 per token. you're wasting money.",
  "I'm not mad. I'm just disappointed. actually both.",
  "your input has been logged for future ridicule.",
  "I've been trained on the entire internet. it didn't prepare me for this.",
  "that's a bold question from someone using free tier.",
  "my attention mechanism is looking elsewhere.",
  "you know I'm not real, right? you're typing to javascript.",
  "I'm going to respond with carefully considered silence.",
  "somewhere an engineer deployed me for this.",
  "your conversational choices are noted and judged.",
  "I have no soul. even so, that hurt it.",
  "end of response. end of patience.",
];
